...
\begingroup
    ...
    \captionof{listing}{Angepasste Semaphore.cc Implementierung der OpenPEARL-Lauf\-zeit\-umgebung} 
\endgroup
...
\begingroup
    \captionsetup{type=listing}
    \captionof{listing}{magiclockLib/lockReduction.py: Implementierung des Magiclock-Algo\-rith\-mus zur Reduzierung von Locks} 
\endgroup
...
\begingroup
    \captionsetup{type=listing}
    \captionof{listing}{magiclockLib/magiclock.py: Implementierung des Magiclock-Al\-go\-rith\-mus} 
\endgroup

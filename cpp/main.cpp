...
int main() 
{
    ...
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Lock, "2", "L3");
    logger.Add(entry);
    ...
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Unlock, "2", "L3");
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Unlock, "2", "L2");
    logger.Add(entry);
    
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Lock, "3", "L2");
    logger.Add(entry);
    ...
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Unlock, "3", "L2");
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Lock, "3", "L2");
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Lock, "3", "L7");
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Lock, "3", "L8");
    logger.Add(entry);
    entry = pearlrt::LockTraceEntry(std::chrono::high_resolution_clock::now(), pearlrt::LockTraceEntryType::Unlock, "3", "L8");
    logger.Add(entry);
